...
date: last-modified
listing:
  - id: developer-modeling-environment
    type: grid
    max-description-length: 250
    sort: false
    fields: [title, description]
    contents:
    - developer-modeling-environment-1.qmd
    - developer-modeling-environment-2.qmd
    - developer-modeling-environment-3.qmd
  - id: developer-with-framework
    type: grid
    max-description-length: 250
    sort: false
    fields: [title, description]
    contents: 
    - developer-with-framework-1.qmd
    - developer-with-framework-2.qmd
    - developer-with-framework-3.qmd
  - id: developer-with-platform-ui
    type: grid
    max-description-length: 250
    sort: false
    fields: [title, description]
    contents: 
    - developer-with-platform-ui-1.qmd
    - developer-with-platform-ui-2.qmd
    - developer-with-platform-ui-3.qmd
---
...
<img src="get-started-validmind.png" alt="Managing users under Settings &gt; User Directory" style="width: 70%; border: 1px solid #333; box-shadow: 5px 5px 5px #ccc, -5px 5px 5px #ccc; border-radius: 5px;"/>


ValidMind offers two primary methods for documenting model risk:

- **Generate documentation**: Through automation, the framework extracts metadata from associated datasets and models for you and generates model documentation. You can also add more documentation and tests manually using the documentation editing capabilities in the ValidMind UI. By generating model documentation
...
When you [**sign up**](https://app.prod.validmind.ai) for ValidMind, you get access to demo models and sample notebooks. We provide these for you to learn how the developer framework works. 

In a production environment, you would build your model, export the datasets and model, and then start using the developer framework.


:::{#developer-modeling-environment}
:::
